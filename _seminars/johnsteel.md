...
<div class="row">
     ...
     <div class="col-sm mt-2 mt-md-0">
        {% include figure.html path="assets/img/ACenter.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.html path="assets/img/Gdansk.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
